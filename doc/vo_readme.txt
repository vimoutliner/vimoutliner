...
- Lines starting with a colon and space word-wrap
  ...
  Lines starting with colons are body text. They should word wrap and should
  be a special color. Verify that paragraphs of body text can be reformatted
  with the Vim gq commands.
...
You can offer it Extra-Distro, either on your own website, or very possibly on
the VimOutliner home page, www.vimoutliner.org.  VimOutliner ships with its
...
feature is available extra-distro on the VimOutliner home page.
